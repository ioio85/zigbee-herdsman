...
= {
    ...
    manuSpecificSinope: {
        ...
        attributes: {
            ...
            airFloorModeParam: {ID: 261, type: DataType.enum8},
            floorMaxAirTemperatureParam: {ID: 264, type: Datatype.int16},
            floorLimitMinParam: {ID: 265, type: Datatype.int16},
            floorLimitMaxParam: {ID: 266, type: Datatype.int16},
            floorSensorTypeParam: {ID: 267, type: DataType.enum8},
            floorLimitStatus: {ID: 268, type: DataType.enum8},
            timeFormatParam: {ID: 276, type: DataType.enum8},
            gcfiStatus: {ID: 277, type: DataType.enum8},
            auxLoadParam: {ID: 280, type: DataType.uint16},
        },
        commands: {
        },
        commandsResponse: {
